...
android {
    namespace = "com.pareto.bypassKeyAttestation"
    compileSdk = 34
    ...
    defaultConfig {
        applicationId = "com.pareto.bypasskeyattestation"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Zip>("zip") {
    ...
    archiveFileName.set("bypassKeyAttestation.zip")
...
tasks.register<Zip>("zip-resetprop") {
    ...
    archiveFileName.set("bypassKeyAttestation-resetprop.zip")
    destinationDirectory.set(project.rootDir.resolve("out"))
